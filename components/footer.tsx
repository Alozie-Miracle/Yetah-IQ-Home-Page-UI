        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 pt-1">
              ...
              <button className="w-full cursor-pointer sm:w-auto px-4 py-2 text-xs font-light tracking-wider text-white bg-teal-600 rounded shadow hover:bg-teal-700 transition-all text-center">
                Register
              </button>
            </div>
          </div>
